    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: theme === 'dark' 
            ? "url('/images/grid-dark.svg')"
            : "url('/images/grid-light.svg')",
      ...
      <div className={`absolute inset-0 z-0 ${
        theme === 'dark' 
          ...
          : 'bg-gradient-to-br from-gray-50 via-emerald-50/30 to-blue-50/30'
      }`} />
      ...
      {[...Array(20)].map((_, i) => (
        <motion.div
          ...
          className={`absolute w-1 h-1 rounded-full ${
            theme === 'dark' ? 'bg-emerald-400/30' : 'bg-emerald-500/20'
          }`}
          animate={{
            y: [0, -100, 0],
      ...
      <motion.div
        ...
        animate={{
          background: theme === 'dark'
            ? [
                'linear-gradient(45deg, rgba(16,185,129,0.1) 0%, rgba(59,130,246,0.1) 50%, rgba(16,185,129,0.1) 100%)',
                'linear-gradient(45deg, rgba(59,130,246,0.1) 0%, rgba(16,185,129,0.1) 50%, rgba(59,130,246,0.1) 100%)',
                'linear-gradient(45deg, rgba(16,185,129,0.1) 0%, rgba(59,130,246,0.1) 50%, rgba(16,185,129,0.1) 100%)',
              ]
            : [
                'linear-gradient(45deg, rgba(16,185,129,0.08) 0%, rgba(59,130,246,0.08) 50%, rgba(16,185,129,0.08) 100%)',
                'linear-gradient(45deg, rgba(59,130,246,0.08) 0%, rgba(16,185,129,0.08) 50%, rgba(59,130,246,0.08) 100%)',
                'linear-gradient(45deg, rgba(16,185,129,0.08) 0%, rgba(59,130,246,0.08) 50%, rgba(16,185,129,0.08) 100%)',
              ],
        }}
        transition={{
